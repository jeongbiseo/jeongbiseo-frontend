    ...
    return (
        <>
            <header className="mt-0">
                <p className="text-title">내 정보 수정</p>
                <h1 className="text-heading-section mt-1">추천 기준 정보</h1>
                <p className="text-text-subtle text-label-medium mt-2">
            ...
            <div className="rounded-control px-container flex h-[47px] items-center justify-between border-[0.5px] border-[#808080] bg-white">
                ...
                <strong className="text-text-muted text-title">
                    {householdSize}명
                </strong>
                <CounterButton
                    label="가구원 수 늘리기"
                ...
                >
                    ...
                    {receivedError && (
                        <div className="py-4 text-center">
                            <p className="text-text-subtle text-label-medium">
                                기수령 지원금을 불러오지 못했어요
                            </p>
                            <button
                                className="text-primary text-label-strong mt-2 cursor-pointer"
                                type="button"
            ...
            {saved && (
                <p
                    className="text-success text-label-strong mt-3 text-center"
                    role="status"
                >
                    수정한 정보를 저장했어요
                </p>
